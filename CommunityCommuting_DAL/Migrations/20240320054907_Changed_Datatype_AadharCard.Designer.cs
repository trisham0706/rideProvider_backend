...
namespace CommunityCommuting_DAL.Migrations
{
    ...
    [Migration("20240320054907_Changed_Datatype_AadharCard")]
    partial class Changed_Datatype_AadharCard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCA_DAL.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("CCA_DAL.Models.Fee", b =>
                {
            ...
            modelBuilder.Entity("CCA_DAL.Models.Trip", b =>
                {
                    b.Property<string>("tripId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CCA_DAL.Models.billMaster", b =>
                {
            ...
            modelBuilder.Entity("CommunityCommuting_DAL.Models.RideProvide", b =>
                {
                    ...
                    b.Property<DateOnly>("validUpto")
                        .HasColumnType("date")
                        .HasAnnotation("MinValue", new DateTime(2024, 4, 19, 11, 19, 6, 500, DateTimeKind.Local).AddTicks(8251));
            ...
            modelBuilder.Entity("CCA_DAL.Models.Booking", b =>
                {
                    b.HasOne("CCA_DAL.Models.Trip", "trips")
                        .WithMany("bookings")
            ...
            modelBuilder.Entity("CCA_DAL.Models.billMaster", b =>
                {
                    b.HasOne("CCA_DAL.Models.Fee", "fees")
